...
from brp.historie_api.models.verblijfadres_binnenland_in_onderzoek import (
...
class VerblijfadresBinnenland(Model):
    ...
    def __init__(
        self,
        officiele_straatnaam=None,
        korte_straatnaam=None,
        huisnummer=None,
        huisletter=None,
        huisnummertoevoeging=None,
        aanduiding_bij_huisnummer=None,
        postcode=None,
        woonplaats=None,
        in_onderzoek=None,
    ):  # noqa: E501
    ...
    def officiele_straatnaam(self, officiele_straatnaam: str):
        ...
        if officiele_straatnaam is not None and len(officiele_straatnaam) > 80:
            raise ValueError(
                "Invalid value for `officiele_straatnaam`, length must be less than or equal to `80`"
            )  # noqa: E501
    ...
    def korte_straatnaam(self, korte_straatnaam: str):
        ...
        if korte_straatnaam is not None and len(korte_straatnaam) > 24:
            raise ValueError(
                "Invalid value for `korte_straatnaam`, length must be less than or equal to `24`"
            )  # noqa: E501
    ...
    def huisnummer(self, huisnummer: int):
        ...
        if huisnummer is not None and huisnummer > 99999:  # noqa: E501
            raise ValueError(
                "Invalid value for `huisnummer`, must be a value less than or equal to `99999`"
            )  # noqa: E501
        if huisnummer is not None and huisnummer < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `huisnummer`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def huisletter(self, huisletter: str):
        ...
        :type huisletter: str
        """
        if huisletter is not None and not re.search(
            r"^[a-zA-Z]{1}$", huisletter
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `huisletter`, must be a follow pattern or equal to `/^[a-zA-Z]{1}$/`"
            )  # noqa: E501
    ...
    def huisnummertoevoeging(self, huisnummertoevoeging: str):
        ...
        :type huisnummertoevoeging: str
        """
        if huisnummertoevoeging is not None and not re.search(
            r"^[a-zA-Z0-9 \-]{1,4}$", huisnummertoevoeging
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `huisnummertoevoeging`, must be a follow pattern or equal to `/^[a-zA-Z0-9 \-]{1,4}$/`"
            )  # noqa: E501
    ...
    def postcode(self, postcode: str):
        ...
        :type postcode: str
        """
        if postcode is not None and not re.search(
            r"^[1-9]{1}[0-9]{3}[ ]?[A-Za-z]{2}$", postcode
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `postcode`, must be a follow pattern or equal to `/^[1-9]{1}[0-9]{3}[ ]?[A-Za-z]{2}$/`"
            )  # noqa: E501
    ...
    def woonplaats(self, woonplaats: str):
        ...
        :type woonplaats: str
        """
        if woonplaats is not None and not re.search(
            r"^[a-zA-Z0-9À-ž \(\)\,\.\-\']{1,80}$", woonplaats
        ):  # noqa: E501
            raise ValueError(
                r"Invalid value for `woonplaats`, must be a follow pattern or equal to `/^[a-zA-Z0-9À-ž \(\)\,\.\-\']{1,80}$/`"
            )  # noqa: E501
